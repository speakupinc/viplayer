...
import { VimePlayer, VimeDailymotion } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeDailymotion } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeDailymotion } from '@viplayer/svelte';
</script>
```
