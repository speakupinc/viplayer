...
import { VimePlayer, VimeDefaultUi } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeDefaultUi } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeDefaultUi } from '@viplayer/svelte';
</script>
```
