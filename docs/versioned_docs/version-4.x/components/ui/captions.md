...
import { VimePlayer, VimeUi, VimeCaptions } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeCaptions } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeUi, VimeCaptions } from '@viplayer/svelte';
</script>
```
