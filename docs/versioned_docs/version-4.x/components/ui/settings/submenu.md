...
import { VimePlayer, VimeUi, VimeSettings, VimeSubmenu } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeSettings, VimeSubmenu } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeUi, VimeSettings, VimeSubmenu } from '@viplayer/svelte';
</script>
```
