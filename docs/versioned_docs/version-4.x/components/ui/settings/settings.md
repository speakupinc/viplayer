...
import { VimePlayer, VimeUi, VimeSettings } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeSettings } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeUi, VimeSettings } from '@viplayer/svelte';
</script>
```
