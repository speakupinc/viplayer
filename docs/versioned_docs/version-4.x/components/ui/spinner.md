...
import { VimePlayer, VimeUi, VimeSpinner } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeSpinner } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeUi, VimeSpinner } from '@viplayer/svelte';
</script>
```
