...
import { VimePlayer, VimeUi, VimeSkeleton } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeSkeleton } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeUi, VimeSkeleton } from '@viplayer/svelte';
</script>
```
