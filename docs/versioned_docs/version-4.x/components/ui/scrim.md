...
import { VimePlayer, VimeUi, VimeScrim } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeScrim } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeUi, VimeScrim } from '@viplayer/svelte';
</script>
```
