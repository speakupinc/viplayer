...
import { VimePlayer, VimeUi, VimeDefaultControls } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeDefaultControls } from '@viplayer/vue';
...
```html {2}
<script lang="ts">
  import { VimePlayer, VimeUi, VimeDefaultControls } from '@viplayer/svelte';
</script>
```
