...
import { VimePlayer, VimeUi, VimeControls } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeControls } from '@viplayer/vue';
...
```html {2}
<script lang="ts">
  import { VimePlayer, VimeUi, VimeControls } from '@viplayer/svelte';
</script>
```
