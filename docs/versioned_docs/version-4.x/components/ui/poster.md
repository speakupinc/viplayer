...
import { VimePlayer, VimeUi, VimePoster } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimePoster } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeUi, VimePoster } from '@viplayer/svelte';
</script>
```
