...
import { VimePlayer, VimeUi, VimeClickToPlay } from '@viplayer/react';
...
<script>
  import { VimePlayer, VimeUi, VimeClickToPlay } from '@viplayer/vue';
...
<script lang="ts">
  import { VimePlayer, VimeUi, VimeClickToPlay } from '@viplayer/svelte';
</script>
```
